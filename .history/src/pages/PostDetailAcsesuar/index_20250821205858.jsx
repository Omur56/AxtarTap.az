...
export default function AcsesuarDetail() {
  ...
  const [zoomIndex, setZoomIndex] = useState(null); // modal üçün index
  ...
  return (
    <div className="post-page max-w-6xl mix-h-screen mx-auto p-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white shadow-lg rounded-xl p-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="border-b pb-4">
            ...
            <p className="text-3xl font-extrabold text-red-600">{post.price} AZN</p>
          </div>
        ...
        <div className="bg-gray-50 border rounded-xl shadow-md p-5 h-fit">
          ...
          <button className="w-full mt-6 py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition">
            Zəng et
          </button>
        </div>
      </div>
      ...
      <div className="grid h-[226px] grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
        {[...accessories].reverse().slice(0, 8).map((item) => (
          <Link key={item._id || item.id} to={`/PostDetailAcsesuar/${item._id || item.id}`}>
            <div className="border rounded-lg bg-white shadow-sm hover:shadow-xl transition duration-200">
              <img
                src={
                ...
                onClick={() => openZoom(0)} // zoom ilk şəkil
              />
              <div className="p-3">
