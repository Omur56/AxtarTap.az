...
export default function AcsesuarDetail() {
  ...
  return (
    <div className="post-page max-w-6xl  mx-auto p-4">
      ...
      <div className="grid grid-cols-1 max-120 lg:grid-cols-3 gap-6 bg-white shadow-lg rounded-xl p-6">
        {/* şəkil + məlumat */}
      ...
      <div className="grid h-[226px] grid-cols-2 sm:grid-cols-2 md:grid-cols-3 min-h-screen lg:grid-cols-4 gap-2">
