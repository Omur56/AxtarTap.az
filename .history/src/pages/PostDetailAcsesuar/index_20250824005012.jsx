...
const [progress, setProgress] = React.useState(0);
  ...
  return (
    <div className="post-page max-w-6xl  mx-auto p-4">
      ...
      <div className="grid justify-items-center mx-auto my-auto max-w-[1000px] grid-cols-1 sm:grid-cols-2 md:grid-cols-3 min-h-screen lg:grid-cols-4 gap-2">
        {[...accessories]
          .reverse()
          .slice(0, 8)
          .map((item) => (
            ...
            >
              <div className="border w-[226px] h-[304px] rounded-lg bg-white shadow-sm hover:shadow-xl transition duration-200">
                ...
                <div className="p-3">
                  ...
                  <p className="text-sm font-semibold text-gray-800 truncate w-62">
                    {item.title}
                  </p>
                  <p className="text-xs text-gray-500 truncate w-62">
                    {item.category}
                  </p>
