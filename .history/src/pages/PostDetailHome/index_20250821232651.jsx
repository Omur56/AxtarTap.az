...
export default function PostDetail() {
  ...
  useEffect(() => {
    ...
    document.addEventListener("keydown", handl)
    }
  })
  ...
  return (
    <div className="post-page max-w-6xl mx-auto p-4">
       <Link to="/Katalog/Ev_veBag"> <button class="flex  items-center gap-2 mt-4 mb-4 bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white shadow-lg rounded-xl p-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <p className="text-3xl font-extrabold text-red-600 mt-4">{post.price} ₼</p>

          <div className="mt-4">
            <h2 className="text-lg font-semibold mb-2">Qeyd</h2>
      ...
      <div className="grid mx-auto my-auto max-w-[1000px] grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {[...home].reverse().slice(0, 8).map((item) => (
          <Link key={item._id} to={`/PostDetailHome/${item._id}`}>
