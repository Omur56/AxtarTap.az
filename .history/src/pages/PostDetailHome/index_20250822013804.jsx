    ...
    <div className="post-page max-w-6xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white shadow-lg rounded-xl p-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed"><span className="font-semibold">Başlıq: </span>{post.title}</p> 
          <p className="text-gray-700 leading-relaxed"><span className="font-semibold">Brend</span>{post.brand}</p> 
          <div className="mt-4">
