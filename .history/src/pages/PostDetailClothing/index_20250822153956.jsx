...
<div className="mt-4">
            <h2 className="text-lg font-semibold mb-2"><span className="font-bold">Başlıq: </span>{post.title}</h2>
            <p className="text-gray-700 leading-relaxed"><span className="font-bold">: </span>{post.type_of_goods}</p>
          </div>
