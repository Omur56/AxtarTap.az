...
<div className="mt-4">
            ...
            <p className="text-gray-700 leading-relaxed">{post.type}</p>
            <p className="text-gray-700 leading-relaxed">{post.category}</p>
            <p className="text-gray-700 leading-relaxed">{post.brand}</p>
            <p className="text-gray-700 leading-relaxed">{post.model}</p>
            <p className="text-gray-700 leading-relaxed">{post.color}</p>
            <p className="text-gray-700 leading-relaxed"><span className="font-semibold">Məsafə:</span>   {post.size}</p>
            <p className="text-gray-700 leading-relaxed">{post.condition}</p>
          </div>
