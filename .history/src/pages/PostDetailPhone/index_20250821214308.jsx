...
export default function PostDetailPhone() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <Link to="/Katalog/Telefonlar" className="inline-block mb-4 text-blue-500 underline">
        ← Geri
      </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white shadow-lg rounded-xl p-6">
        ...
        <div className="bg-gray-50 border rounded-xl shadow-md p-5 h-fit">
          ...
          <button className="w-full mt-6 py-3 bg-green-500 hover:bg-red-700 text-white font-bold rounded-lg transition">
            <a href={`tel:${post?.contact.phone}`} className="text-white font-bold ml-1">Zəng et</a>
          </button>
        </div>
      </div>
      ...
      <div className="grid mx-auto max-w-[1000px] grid-cols-2 rounded-2xl  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
