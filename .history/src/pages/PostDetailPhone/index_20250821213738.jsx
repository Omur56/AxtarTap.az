...
export default function ProductDetails() {
 ...
 {/* Bənzər elanlar */}
        <div className="grid mx-auto grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <h2 className="text-xl font-bold text-gray-700 mb-4">Bənzər elanlar</h2>
          <div className="grid grid-cols-2 md:grid-cols-1 gap-4">
            {[...Phone].reverse().slice(0, 6).map((item) => (
              <Link key={item._id} to={`/PostDetailPhone/${item._id}`}>
                <div className="border w-[220px] h-[300px] rounded-lg bg-white shadow-sm hover:shadow-xl transition duration-200">
                  <img
                  ...
                  <div className="p-2">
                    ...
                    <p className="text-sm font-bold truncate w-52">{item.title}</p>
