...
export default function PostDetailRealEstate() {
  ...
  if (notFound || !post) return <div class="h-screen w-full flex flex-col justify-center items-center bg-gradient-to-r from-fuchsia-100 to-violet-200">
	<h1 class="text-9xl font-extrabold text-gradient-to-r from-slate-800 to-gray-800 tracking-widest">404</h1>
	...
	<button class="mt-5">
      ...
      >
        <span
          class="absolute inset-0 transition-transform translate-x-0.5 translate-y-0.5 bg-yello group-hover:translate-y-0 group-hover:translate-x-0"
        ></span>
