...
export default function PostDetailRealEstate() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <Link
        to="/Katalog/Əmlak"
        className="inline-block mb-4 text-blue-500 underline"
      >
        ← Geri
      </Link>
      ...
      <div className="max-w-[1200px] p-4 rounded-[8px] grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[15px] mt-4 w-full bg-white">
