...
export default function PostDetailRealEstate() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white shadow-lg rounded-xl p-6">
          {isLoading ? (
            Array.from({ length: 1 }).map((_, i) => (
              ...
              >
                <div className="w-fu h-[400px] rounded-t-[8px] mb-2 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 animate-shimmer"></div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <ul className="text-sm text-gray-700 space-y-1 mt-4">
            ...
            <li>
              <span className="font-bold">Otaqlar:</span> {post.number_of_rooms}
            </li>
            <li>
      ...
      <div className="max-w-[1000px] p-4 rounded-[8px] grid justify-items-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[15px] mt-4 w-full">
