 ...
 useEffect(() => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
       <Link to="/Katalog/Daşınmaz_əmlak"> <button class="flex  items-center gap-2 mt-4 mb-4 bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md">
