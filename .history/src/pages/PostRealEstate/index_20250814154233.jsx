      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white shadow-md rounded-xl p-4">
        ...
        <div className="space-y-3 mt-[60px]">
          ...
          <ul className="text-xl underline list-inside text-gray-700 space-y-1">
            <li><span className="font-bold">Elanın Adı: </span>{post.title_typee}</li>
            <li><span className="font-bold">Elanın növü: </span>{post.type_building}</li>
            <li><span className="font-bold">Elan Bölməsi: </span>{post.field}</li>
            <li><span className="font-bold">Otaqlar: </span>{post.number_of_rooms}</li>
            <li><span className="font-bold">Yerləşmə: </span>{post.location}</li>
            <li><span className="font-bold">Şəhər: </span>{post.city}</li>
        ...
        <p className="text-sm text-black">Elanın nömrəsi:  {post._id}</p>
        ...
        <Link key={item._id} to={`/PostRealEstate/${item._id}`}>
          <div className="border sm:w-[240.4px] max-w-[240.4px] h-[300px] rounded-lg bg-white shadow-md hover:shadow-xl transition duration-150">
            ...
            <div className="p-4">
              ...
              <h2 className="text-sm font-bold truncate w-64">{item.title_typee}</h2>
              <h3 className="text-lg font-semibold truncate w-64">{item.type_building}</h3>
