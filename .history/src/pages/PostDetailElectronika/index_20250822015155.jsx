        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <p className="text-3xl font-extrabold text-red-600 mt-4">
            {post.price} AZN
             ...
             <p className="text-gray-700 leading-relaxed"><span className="font-semibold">Başlıq:</span>{post.description}</p>
             <p className="text-gray-700 leading-relaxed"><span className="font-semibold">Açıqlama:</span>{post.description}</p>
          <div className="mt-4">
