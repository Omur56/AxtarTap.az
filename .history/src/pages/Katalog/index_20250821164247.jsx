...
const Katalog = () => {
  ...
  return (
    ...
    <div className="min-h-[100px] w-full bg-gradient-to-r items-center justify-center from-blue-600 to-slate-900 rounded-t-[10px]">
    <div className=" justify-center mx-auto my-[50px]  max-w-[1000px]  grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-8 gap-4 ">
      {categories.map((cat) => (
        <Link
          key={cat.id}
