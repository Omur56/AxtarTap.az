    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white shadow-lg rounded-xl p-6">
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="mt-4">
            <p className="text-black text-sm"><span className="font-500 text-black  ">Məhsulun adı: </span> {post.title}</p>
            <p className="text-black text-sm"><span className="font-500 text-black ">Kateqoriya: </span> {post.category} </p>
            <p className="text-black text-sm"><span className="font-500 text-black ">Məhsul tipi: </span>{post.type_of_goods} </p>
