    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white shadow-lg rounded-xl p-6">
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="mt-4">
            <p className="text-black text-sm"><span className="font-bold text-black font-xs ">Məhsulun adı: </span> {post.title}</p>
            <p className="text-black text-sm"><span className="font-bold text-black font-xs">Kateqoriya: </span> {post.category} </p>
            <p className="text-black text-sm"><span className="font-bold text-black font-xs">Məhsul tipi: </span>{post.type_of_goods} </p>
            
            <p className="text-gray-700 leading-relaxed"><span className="font-bold">Təsvir: </span> {post.description}</p>
          </div>
      ...
      <div className="grid mx-auto max-w-[1000px] grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {[...household]
          ...
          .map((item) => (
            <Link  target="_blank"
            rel="noopener noreferrer" key={item.id} to={`/PostDetailHousehold/${item._id}`}>
