...
const Contact = () => {
    return (
        <div className="min-h-screen j">
            <div className="max-w-4xl mx-auto p-8 mt-12 mb-12  items-center bg-gradient-to-r from-green-50 via-blue-50 to-purple-50 rounded-3xl shadow-2xl">
