...
const Home = () => {
  ...
  return (
    ...
    <div className="flex justfen-betwen">
 <div className="w-1/6 z-50 fixed space-y-4 min-h-screen">
...
/>
      ...
      <CircularProgress />
        ...
        <div className="p-4 mt-6  justify-items-center rounded-[4px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px] w-full">
          {isLoading ? (
      ...
      <div className="w-1/6 fixed min-h-screen z-50 left-5 space-y-4">
