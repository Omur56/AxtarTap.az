...
useEffect(() => {
  const fetchAll = async () => {
    ...
    try {
      const [carsRes, homeGardenRes, elektronikaRes, accessoriesRes, realEstateRes, householdRes, phoneRes, clothingRes] = await Promise.all([
...
<div className="p-4 justify-items-center rounded-[4px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px] w-full">
  {isLoading ? (
  ...
  <div className="h-4 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 rounded w-1/2 animate-shimmer"></div>
   ...
   <div className="h-4 mt-[4px] bg-gray-300 rounded w-2/3 animate-shimmer"></div>
    ...
    <>
        ...
        <Link target="_blank"
          ...
          <div className="sm:w-[240.4px] max-w-[240.4px] h-[300px] bg-white rounded-2xl shadow-lg transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
            ...
            <div className="p-2">
              ...
              <p className="text-gray-600 truncate w-64">{car.year}, {car.km} km</p>
      ...
      {[...homeGarden].map((post) => (
        <Link target="_blank"
            rel="noopener noreferrer" key={post._id} to={`/elan/${post._id}`}>
          <div className="sm:w-[240.4px] max-w-[240.4px] h-[300px] bg-white rounded-2xl shadow-lg transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
            <img
              src={
            ...
            <div className="p-4">
              ...
              <h2 className="text-sm font-bold truncate w-62">{post.title}</h2>
    ...
    <Link target="_blank"
      ...
      <div className="sm:w-[240.4px] max-w-[240.4px] h-[300px]  bg-white rounded-2xl  shadow-lg transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
        ...
        <div className="p-4">
          ...
          <h2 className="text-sm font-bold truncate w-62">{item.category}</h2>
          <h3 className="text-lg font-semibold truncate w-62">{item.title}</h3>
          <p className="capitalize text-gray-400 text-[16px]">
  ...
  {[...accessories ].reverse().map((item) => (
    <Link target="_blank"
            rel="noopener noreferrer" key={item._id} to={`/PostDetailAcsesuar/${item._id}`}>
      <div className="sm:w-[240.4px] max-w-[240.4px] h-[300px]  bg-white rounded-2xl  shadow-lg transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
  ...
  {[...realEstate].reverse().map((item) => (
    <Link target="_blank"
            rel="noopener noreferrer" key={item._id} to={`/PostRealEstate/${item._id}`}>
      <div className="sm:w-[240.4px] max-w-[240.4px] h-[300px]  bg-white rounded-2xl  shadow-lg transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
        ...
        <div className="p-4">
          <h3 className="text-xl font-bold text-black">{item.price} AZN ₼</h3>
          <h2 className="text-sm font-bold truncate w-62">{item.title_type}, {item.type_building}, {item.location}</h2>
   ...
   {[...Household].reverse().map((item) => (
    <Link target="_blank"
            rel="noopener noreferrer" key={item._id} to={`/PostDetailHousehold/${item._id}`}>
      <div className="sm:w-[240.4px] max-w-[240.4px] h-[300px]  bg-white rounded-2xl  shadow-lg transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
        ...
        <div className="p-4">
          <h3 className="text-xl font-bold text-black">{item.price} AZN ₼</h3>
          <h2 className="text-sm font-boldtruncate w-62">{item.title}, {item.category}, {item.location}</h2>
   ...
   {[...Phone ].reverse().map((item) => (
    <Link target="_blank"
      ...
      <div className="sm:w-[240.4px] max-w-[240.4px] h-[300px]  bg-white rounded-2xl  shadow-lg transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
        ...
        <div className="p-4">
          <h3 className="text-xl font-bold text-black">{item.price} AZN ₼</h3>
          <h2 className="text-lg font-bold truncate w-62">{item.title}, {item.brand}, {item.model}</h2>
