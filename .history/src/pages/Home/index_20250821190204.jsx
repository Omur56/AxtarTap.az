...
useEffect(() => {
 ...
 <div className="max-w-5xl mx-auto p-4 flex flex-col gap-">
...
<div className="p-4 rounded-[4px] grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[15px] w-full">
  {isLoading ? (
