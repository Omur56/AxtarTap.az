    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      {zoomIndex !== null && (
        ...
        >
          ...
          />
          <button
            className="absolute hover:bg-slate-300 right-5 text-white text-8xl w-10 h-10 font-500 z-50"
            onClick={(e) => {
              e.stopPropagation();
              nextImage();
            }}
          ><span className="text-white text-8xl w-10 h-10 font-500 z-50">  › </span>
          </button>
        </div>
      )}
    </div>
