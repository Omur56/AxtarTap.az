    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      {zoomIndex !== null && (
        ...
        >
          ...
          />
          <button
            className="absolute justify-center mx-auto my-auto items-center right-5 text-white text-8xl w-20 h-20 font-500 z-50"
            onClick={(e) => {
              e.stopPropagation();
              nextImage();
            }}
          ><span className="hover:bg-red-600 border border-red-600 rounded-2xl h-20 w-20">  › </span>
          </button>
        </div>
      )}
    </div>
